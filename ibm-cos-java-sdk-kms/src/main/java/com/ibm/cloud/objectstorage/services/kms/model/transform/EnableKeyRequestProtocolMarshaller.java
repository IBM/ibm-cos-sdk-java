...
@SdkInternalApi
public class EnableKeyRequestProtocolMarshaller implements Marshaller<Request<EnableKeyRequest>, EnableKeyRequest> {
    ...
    public EnableKeyRequestProtocolMarshaller(com.ibm.cloud.objectstorage.protocol.json.SdkJsonProtocolFactory protocolFactory) {
