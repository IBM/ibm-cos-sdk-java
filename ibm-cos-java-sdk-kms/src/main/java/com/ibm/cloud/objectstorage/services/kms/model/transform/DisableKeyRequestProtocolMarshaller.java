...
@SdkInternalApi
public class DisableKeyRequestProtocolMarshaller implements Marshaller<Request<DisableKeyRequest>, DisableKeyRequest> {
    ...
    public DisableKeyRequestProtocolMarshaller(com.ibm.cloud.objectstorage.protocol.json.SdkJsonProtocolFactory protocolFactory) {
