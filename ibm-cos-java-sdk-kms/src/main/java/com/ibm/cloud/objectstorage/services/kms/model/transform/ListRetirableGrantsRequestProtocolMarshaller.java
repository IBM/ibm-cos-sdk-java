...
@SdkInternalApi
public class ListRetirableGrantsRequestProtocolMarshaller implements Marshaller<Request<ListRetirableGrantsRequest>, ListRetirableGrantsRequest> {
    ...
    public ListRetirableGrantsRequestProtocolMarshaller(com.ibm.cloud.objectstorage.protocol.json.SdkJsonProtocolFactory protocolFactory) {
