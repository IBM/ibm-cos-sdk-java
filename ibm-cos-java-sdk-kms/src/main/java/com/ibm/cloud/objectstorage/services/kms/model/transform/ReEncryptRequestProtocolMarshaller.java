...
@SdkInternalApi
public class ReEncryptRequestProtocolMarshaller implements Marshaller<Request<ReEncryptRequest>, ReEncryptRequest> {
    ...
    public ReEncryptRequestProtocolMarshaller(com.ibm.cloud.objectstorage.protocol.json.SdkJsonProtocolFactory protocolFactory) {
