...
@SdkInternalApi
public class RetireGrantRequestProtocolMarshaller implements Marshaller<Request<RetireGrantRequest>, RetireGrantRequest> {
    ...
    public RetireGrantRequestProtocolMarshaller(com.ibm.cloud.objectstorage.protocol.json.SdkJsonProtocolFactory protocolFactory) {
