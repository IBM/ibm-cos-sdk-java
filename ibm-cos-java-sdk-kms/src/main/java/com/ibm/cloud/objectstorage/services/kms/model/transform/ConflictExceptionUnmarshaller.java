...
import com.ibm.cloud.objectstorage.services.kms.model.ConflictException;
...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(ConflictException.class, "ConflictException");
    }

    @Override
    public ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
