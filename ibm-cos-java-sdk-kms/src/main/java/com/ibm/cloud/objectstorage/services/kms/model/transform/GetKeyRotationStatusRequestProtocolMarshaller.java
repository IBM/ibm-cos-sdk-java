...
@SdkInternalApi
public class GetKeyRotationStatusRequestProtocolMarshaller implements Marshaller<Request<GetKeyRotationStatusRequest>, GetKeyRotationStatusRequest> {
    ...
    public GetKeyRotationStatusRequestProtocolMarshaller(com.ibm.cloud.objectstorage.protocol.json.SdkJsonProtocolFactory protocolFactory) {
