...
public class ListRetirableGrantsResult extends com.ibm.cloud.objectstorage.AmazonWebServiceResult<com.ibm.cloud.objectstorage.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private com.ibm.cloud.objectstorage.internal.SdkInternalList<GrantListEntry> grants;
    /**
     * <p>
    ...
    public java.util.List<GrantListEntry> getGrants() {
        if (grants == null) {
            grants = new com.ibm.cloud.objectstorage.internal.SdkInternalList<GrantListEntry>();
        }
        return grants;
    }
    ...
    public void setGrants(java.util.Collection<GrantListEntry> grants) {
        ...
        this.grants = new com.ibm.cloud.objectstorage.internal.SdkInternalList<GrantListEntry>(grants);
    }
    ...
    public ListRetirableGrantsResult withGrants(GrantListEntry... grants) {
        if (this.grants == null) {
            setGrants(new com.ibm.cloud.objectstorage.internal.SdkInternalList<GrantListEntry>(grants.length));
        }
