...
@SdkInternalApi
public class DeleteImportedKeyMaterialRequestProtocolMarshaller implements
        Marshaller<Request<DeleteImportedKeyMaterialRequest>, DeleteImportedKeyMaterialRequest> {
    ...
    public DeleteImportedKeyMaterialRequestProtocolMarshaller(com.ibm.cloud.objectstorage.protocol.json.SdkJsonProtocolFactory protocolFactory) {
