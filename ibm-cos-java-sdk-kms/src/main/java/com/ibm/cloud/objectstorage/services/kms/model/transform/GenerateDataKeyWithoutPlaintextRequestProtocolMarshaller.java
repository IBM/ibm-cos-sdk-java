...
@SdkInternalApi
public class GenerateDataKeyWithoutPlaintextRequestProtocolMarshaller implements
    ...
    public GenerateDataKeyWithoutPlaintextRequestProtocolMarshaller(com.ibm.cloud.objectstorage.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<GenerateDataKeyWithoutPlaintextRequest> marshall(GenerateDataKeyWithoutPlaintextRequest generateDataKeyWithoutPlaintextRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<GenerateDataKeyWithoutPlaintextRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(
                    SDK_OPERATION_BINDING, generateDataKeyWithoutPlaintextRequest);
