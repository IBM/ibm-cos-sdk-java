...
@SdkInternalApi
public class DisableKeyRotationRequestProtocolMarshaller implements Marshaller<Request<DisableKeyRotationRequest>, DisableKeyRotationRequest> {
    ...
    public DisableKeyRotationRequestProtocolMarshaller(com.ibm.cloud.objectstorage.protocol.json.SdkJsonProtocolFactory protocolFactory) {
    ...
    public Request<DisableKeyRotationRequest> marshall(DisableKeyRotationRequest disableKeyRotationRequest) {
        ...
        try {
            final ProtocolRequestMarshaller<DisableKeyRotationRequest> protocolMarshaller = protocolFactory.createProtocolMarshaller(SDK_OPERATION_BINDING,
