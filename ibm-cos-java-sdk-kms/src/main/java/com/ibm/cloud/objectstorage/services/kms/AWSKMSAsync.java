 ...
 * {@link com.ibm.cloud.objectstorage.services.kms.AbstractAWSKMSAsync} instead.
 * </p>
 * <p>
...
public interface AWSKMSAsync extends AWSKMS {
     ...
     */
//    java.util.concurrent.Future<ConnectCustomKeyStoreResult> connectCustomKeyStoreAsync(ConnectCustomKeyStoreRequest connectCustomKeyStoreRequest,
//            com.ibm.cloud.objectstorage.handlers.AsyncHandler<ConnectCustomKeyStoreRequest, ConnectCustomKeyStoreResult> asyncHandler);
     ...
     */
    //java.util.concurrent.Future<CreateCustomKeyStoreResult> createCustomKeyStoreAsync(CreateCustomKeyStoreRequest createCustomKeyStoreRequest,
     //       com.ibm.cloud.objectstorage.handlers.AsyncHandler<CreateCustomKeyStoreRequest, CreateCustomKeyStoreResult> asyncHandler);
    ...
    java.util.concurrent.Future<CreateGrantResult> createGrantAsync(CreateGrantRequest request);
     ...
     */
    java.util.concurrent.Future<CreateKeyResult> createKeyAsync(com.ibm.cloud.objectstorage.handlers.AsyncHandler<CreateKeyRequest, CreateKeyResult> asyncHandler);
     ...
     */
    //java.util.concurrent.Future<DeleteCustomKeyStoreResult> deleteCustomKeyStoreAsync(DeleteCustomKeyStoreRequest deleteCustomKeyStoreRequest,
     //       com.ibm.cloud.objectstorage.handlers.AsyncHandler<DeleteCustomKeyStoreRequest, DeleteCustomKeyStoreResult> asyncHandler);
...
//    IBM Unsupported
//    java.util.concurrent.Future<DescribeCustomKeyStoresResult> describeCustomKeyStoresAsync(DescribeCustomKeyStoresRequest describeCustomKeyStoresRequest,
//            com.ibm.cloud.objectstorage.handlers.AsyncHandler<DescribeCustomKeyStoresRequest, DescribeCustomKeyStoresResult> asyncHandler);
...
//    IBM Unsupported
//    java.util.concurrent.Future<DisconnectCustomKeyStoreResult> disconnectCustomKeyStoreAsync(DisconnectCustomKeyStoreRequest disconnectCustomKeyStoreRequest,
//            com.ibm.cloud.objectstorage.handlers.AsyncHandler<DisconnectCustomKeyStoreRequest, DisconnectCustomKeyStoreResult> asyncHandler);
     ...
     */
    //java.util.concurrent.Future<GenerateDataKeyPairResult> generateDataKeyPairAsync(GenerateDataKeyPairRequest generateDataKeyPairRequest,
     //       com.ibm.cloud.objectstorage.handlers.AsyncHandler<GenerateDataKeyPairRequest, GenerateDataKeyPairResult> asyncHandler);
    ...
    //java.util.concurrent.Future<GenerateDataKeyPairWithoutPlaintextResult> generateDataKeyPairWithoutPlaintextAsync(
     //       GenerateDataKeyPairWithoutPlaintextRequest generateDataKeyPairWithoutPlaintextRequest,
      //      com.ibm.cloud.objectstorage.handlers.AsyncHandler<GenerateDataKeyPairWithoutPlaintextRequest, GenerateDataKeyPairWithoutPlaintextResult> asyncHandler);
     ...
     */
    //java.util.concurrent.Future<GetPublicKeyResult> getPublicKeyAsync(GetPublicKeyRequest getPublicKeyRequest,
     //       com.ibm.cloud.objectstorage.handlers.AsyncHandler<GetPublicKeyRequest, GetPublicKeyResult> asyncHandler);
     ...
     */
    java.util.concurrent.Future<ListAliasesResult> listAliasesAsync(com.ibm.cloud.objectstorage.handlers.AsyncHandler<ListAliasesRequest, ListAliasesResult> asyncHandler);
     ...
     */
    java.util.concurrent.Future<ListKeysResult> listKeysAsync(com.ibm.cloud.objectstorage.handlers.AsyncHandler<ListKeysRequest, ListKeysResult> asyncHandler);
    ...
    // IBM Unsupported
    //java.util.concurrent.Future<ReplicateKeyResult> replicateKeyAsync(ReplicateKeyRequest request);
     ...
     */
    java.util.concurrent.Future<RetireGrantResult> retireGrantAsync(com.ibm.cloud.objectstorage.handlers.AsyncHandler<RetireGrantRequest, RetireGrantResult> asyncHandler);
     ...
     * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/kms-2014-11-01/Sign" target="_top">AWS API Documentation</a>
     */
    // java.util.concurrent.Future<SignResult> signAsync(SignRequest signRequest, com.ibm.cloud.objectstorage.handlers.AsyncHandler<SignRequest, SignResult> asyncHandler);
     ...
     */
    //java.util.concurrent.Future<UpdateCustomKeyStoreResult> updateCustomKeyStoreAsync(UpdateCustomKeyStoreRequest updateCustomKeyStoreRequest,
     //       com.ibm.cloud.objectstorage.handlers.AsyncHandler<UpdateCustomKeyStoreRequest, UpdateCustomKeyStoreResult> asyncHandler);
     ...
     */
    // ? java.util.concurrent.Future<UpdatePrimaryRegionResult> updatePrimaryRegionAsync(UpdatePrimaryRegionRequest updatePrimaryRegionRequest,
      //      com.ibm.cloud.objectstorage.handlers.AsyncHandler<UpdatePrimaryRegionRequest, UpdatePrimaryRegionResult> asyncHandler);
