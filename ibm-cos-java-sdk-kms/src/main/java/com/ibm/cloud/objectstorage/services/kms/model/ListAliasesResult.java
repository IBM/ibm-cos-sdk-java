...
public class ListAliasesResult extends com.ibm.cloud.objectstorage.AmazonWebServiceResult<com.ibm.cloud.objectstorage.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public java.util.List<AliasListEntry> getAliases() {
        if (aliases == null) {
            aliases = new com.ibm.cloud.objectstorage.internal.SdkInternalList<AliasListEntry>();
        }
        return aliases;
    }
    ...
    public void setAliases(java.util.Collection<AliasListEntry> aliases) {
        ...
        this.aliases = new com.ibm.cloud.objectstorage.internal.SdkInternalList<AliasListEntry>(aliases);
    }
    ...
    public ListAliasesResult withAliases(AliasListEntry... aliases) {
        if (this.aliases == null) {
            setAliases(new com.ibm.cloud.objectstorage.internal.SdkInternalList<AliasListEntry>(aliases.length));
        }
