...
@SdkInternalApi
public class EncryptRequestProtocolMarshaller implements Marshaller<Request<EncryptRequest>, EncryptRequest> {
    ...
    public EncryptRequestProtocolMarshaller(com.ibm.cloud.objectstorage.protocol.json.SdkJsonProtocolFactory protocolFactory) {
