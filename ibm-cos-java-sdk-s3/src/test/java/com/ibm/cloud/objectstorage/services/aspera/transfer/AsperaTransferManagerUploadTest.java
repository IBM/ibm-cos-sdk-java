...
public class AsperaTransferManagerUploadTest {
    ...
    @Mock
    private File mockFileToUpload = mock(File.class);
	...
	public void testExceptionThrownWhenNullBucketName() {
	    ...
	    spyAtm.upload(null, mockFileToUpload, TEST_REMOTE_FILENAME);
	}
	...
	public void testExceptionThrownWhenEmptyBuckName() throws Exception {
	    ...
	    spyAtm.upload("", mockFileToUpload, TEST_REMOTE_FILENAME);
	}
	 ...
	 */
	@Test
	public void testExceptionThrownWhenNullUploadFile() {
		expectedEx.expect(SdkClientException.class);
	    ...
	    spyAtm.upload(TEST_BUCKET_NAME, null, TEST_REMOTE_FILENAME);
	}
	...
	public void testExceptionThrownWhenFileToUploadDoesNotExist() {
	    ...
	    when(mockFileToUpload.exists()).thenReturn(false);
	    ...
	    spyAtm.upload(TEST_BUCKET_NAME, mockFileToUpload, TEST_REMOTE_FILENAME);
	}
	...
	public void testExceptionThrownWhenNullRemoteFileName() {
	    ...
	    when(mockFileToUpload.exists()).thenReturn(true);
	    ...
	    spyAtm.upload(TEST_BUCKET_NAME, mockFileToUpload, null);
	}
	...
	public void testExceptionThrownWhenEmptyRemoteFileName() {
	    ...
	    spyAtm.upload(TEST_BUCKET_NAME, mockFileToUpload, "");
	}
}
