...
class AesGcm extends ContentCryptoScheme {
    ...
    @Override
    public String getCipherAlgorithm() { return "AES/GCM/NoPadding"; }
    @Override
    public int getKeyLengthInBits() { return 256; }
    @Override
    public int getBlockSizeInBytes() { return 16; }
    @Override
    public int getIVLengthInBytes() { return 12; }
