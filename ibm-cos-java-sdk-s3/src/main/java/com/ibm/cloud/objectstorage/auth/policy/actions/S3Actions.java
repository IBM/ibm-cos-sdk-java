...
import com.ibm.cloud.objectstorage.auth.policy.resources.S3BucketResource;
import com.ibm.cloud.objectstorage.auth.policy.resources.S3ObjectResource;
...
public enum S3Actions implements Action {
     ...
     *
     * @see AmazonS3#getObject(com.ibm.cloud.objectstorage.services.s3.model.GetObjectRequest)
     * @see AmazonS3#getObjectMetadata(com.ibm.cloud.objectstorage.services.s3.model.GetObjectMetadataRequest)
     */
     ...
     * Valid for use with {@link S3ObjectResource} resources.
     *
     * @see AmazonS3#putObject(com.ibm.cloud.objectstorage.services.s3.model.PutObjectRequest)
     */
     ...
     *      com.ibm.cloud.objectstorage.services.s3.model.AccessControlList)
     * @see AmazonS3#setObjectAcl(String, String,
     *      com.ibm.cloud.objectstorage.services.s3.model.CannedAccessControlList)
     */
     ...
     * Valid for use with {@link S3ObjectResource} resources.
     *
     * @see AmazonS3#deleteObject(com.ibm.cloud.objectstorage.services.s3.model.DeleteObjectRequest)
     */
     ...
     * Valid for use with {@link S3ObjectResource} resources.
     *
     * @see AmazonS3#deleteVersion(com.ibm.cloud.objectstorage.services.s3.model.DeleteVersionRequest)
     */
     ...
     *
     * @see AmazonS3#listParts(com.ibm.cloud.objectstorage.services.s3.model.ListPartsRequest)
     */
     ...
     *
     * @see AmazonS3#abortMultipartUpload(com.ibm.cloud.objectstorage.services.s3.model.AbortMultipartUploadRequest)
     */
     ...
     *
     * @see AmazonS3#restoreObject(com.ibm.cloud.objectstorage.services.s3.model.RestoreObjectRequest)
     */
     ...
     *
     * @see AmazonS3#createBucket(com.ibm.cloud.objectstorage.services.s3.model.CreateBucketRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#deleteBucket(com.ibm.cloud.objectstorage.services.s3.model.DeleteBucketRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#listObjects(com.ibm.cloud.objectstorage.services.s3.model.ListObjectsRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#listVersions(com.ibm.cloud.objectstorage.services.s3.model.ListVersionsRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#listMultipartUploads(com.ibm.cloud.objectstorage.services.s3.model.ListMultipartUploadsRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#setBucketCrossOriginConfiguration(com.ibm.cloud.objectstorage.services.s3.model.SetBucketCrossOriginConfigurationRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#setBucketVersioningConfiguration(com.ibm.cloud.objectstorage.services.s3.model.SetBucketVersioningConfigurationRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#deleteBucketPolicy(com.ibm.cloud.objectstorage.services.s3.model.DeleteBucketPolicyRequest)
     */
     ...
     *      com.ibm.cloud.objectstorage.services.s3.model.BucketNotificationConfiguration)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#setBucketLoggingConfiguration(com.ibm.cloud.objectstorage.services.s3.model.SetBucketLoggingConfigurationRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#setBucketTaggingConfiguration(com.ibm.cloud.objectstorage.services.s3.model.SetBucketTaggingConfigurationRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#getBucketWebsiteConfiguration(com.ibm.cloud.objectstorage.services.s3.model.GetBucketWebsiteConfigurationRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#setBucketWebsiteConfiguration(com.ibm.cloud.objectstorage.services.s3.model.SetBucketWebsiteConfigurationRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#deleteBucketWebsiteConfiguration(com.ibm.cloud.objectstorage.services.s3.model.DeleteBucketWebsiteConfigurationRequest)
     */
     ...
     * Valid for use with {@link S3BucketResource} resources.
     *
     * @see AmazonS3#setBucketLifecycleConfiguration(com.ibm.cloud.objectstorage.services.s3.model.SetBucketLifecycleConfigurationRequest)
     */
     ...
     * (non-Javadoc)
     *
     * @see com.ibm.cloud.objectstorage.auth.policy.Action#getId()
     */
