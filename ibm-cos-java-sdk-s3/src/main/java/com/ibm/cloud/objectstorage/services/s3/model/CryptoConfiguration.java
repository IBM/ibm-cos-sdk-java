...
public class CryptoConfiguration implements Cloneable,Serializable {
     ...
     */
    private transient com.ibm.cloud.objectstorage.regions.Region awskmsRegion;
     ...
     * regions.
     *
     * @use {@link #setAwsKmsRegion(com.ibm.cloud.objectstorage.regions.Region)} instead
     */
    @Deprecated
     ...
     * regions.
     *
     * @use {@link #withAwsKmsRegion(com.ibm.cloud.objectstorage.regions.Region)} AwsKmsRegion}
     * instead
     */
    @Deprecated
