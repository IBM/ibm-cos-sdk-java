...
public class UploadImpl extends AbstractTransfer implements Upload {
     ...
     * (non-Javadoc)
     *
     * @see com.ibm.cloud.objectstorage.services.s3.transfer.Upload#pause()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.ibm.cloud.objectstorage.services.s3.transfer.Upload#tryPause(boolean)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.ibm.cloud.objectstorage.services.s3.transfer.Upload#abort()
     */
    @Override
    public void abort() {
        UploadMonitor uploadMonitor = (UploadMonitor) monitor;
