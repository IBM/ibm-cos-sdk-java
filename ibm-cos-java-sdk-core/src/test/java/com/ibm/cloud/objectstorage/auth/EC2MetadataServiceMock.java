...
public class EC2MetadataServiceMock {
     ...
     * this mock server. The files are loaded from the com/ibm/cloud/objectstorage/auth
            ...
            while (true) {
                ...
                try {
                    ...
                    if (resourcePath.equals("/latest/api/token")) {
                        ...
                        String responseFilePath = "/com/ibm/cloud/objectstorage/auth/" + responseFileName + ".json";
