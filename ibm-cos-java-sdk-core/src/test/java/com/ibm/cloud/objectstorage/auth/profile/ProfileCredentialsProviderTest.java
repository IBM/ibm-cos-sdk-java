...
import com.ibm.cloud.objectstorage.auth.profile.internal.securitytoken.RoleInfo;
...
public class ProfileCredentialsProviderTest {
    ...
    public void testForcedRefresh() throws Exception {
        ...
        ProfileCredentialsProvider profileCredentialsProvider = new ProfileCredentialsProvider(
             ...
             * If this wait is not here, com.ibm.cloud.objectstorage.auth.profile.ProfilesConfigFile.refresh() profileFile.lastModified() will not be updated, therefore the
