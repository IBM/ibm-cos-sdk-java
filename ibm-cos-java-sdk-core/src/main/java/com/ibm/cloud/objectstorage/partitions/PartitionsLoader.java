...
import com.ibm.cloud.objectstorage.partitions.model.Partitions;
...
public class PartitionsLoader {
    ...
    public static final String PARTITIONS_RESOURCE_PATH =
            "com/ibm/cloud/objectstorage/partitions/endpoints.json";
    ...
    public static final String PARTITIONS_OVERRIDE_RESOURCE_PATH =
            "com/ibm/cloud/objectstorage/partitions/override/endpoints.json";
