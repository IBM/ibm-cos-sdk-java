...
public class AwsResponseHandlerAdapter<T> implements HttpResponseHandler<T> {
     ...
     */
    private static final Log requestIdLog = LogFactory.getLog("com.ibm.cloud.objectstorage.requestId");
     ...
     * executed. The request id is logged using the "com.ibm.cloud.objectstorage.requestId" logger if it was
     * enabled at DEBUG level; otherwise, it is logged at DEBUG level using the
     * "com.ibm.cloud.objectstorage.request" logger.
     *
     ...
     * request id is logged using the "com.ibm.cloud.objectstorage.requestId" logger if it was enabled at DEBUG
     * level; otherwise, it is logged using at DEBUG level using the "com.ibm.cloud.objectstorage.request"
     * logger.
     */
