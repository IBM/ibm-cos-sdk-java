...
public abstract class AmazonWebServiceClient {
    ...
    static {
        ...
        // rest of the library.
        boolean success = com.ibm.cloud.objectstorage.log.InternalLogFactory.configureFactory(
     ...
     *            {@link Region#getRegion(com.ibm.cloud.objectstorage.regions.Regions)} for accessing a given
     *            region.
     ...
     * @see Region#createClient(Class, com.ibm.cloud.objectstorage.auth.AWSCredentialsProvider,
     *      ClientConfiguration)
